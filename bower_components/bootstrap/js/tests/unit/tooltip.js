$(function () {
    ...
    test("should destroy tooltip", function () {
        ...
        ok(!$._data(tooltip[0], 'events').mouseover && !$._data(tooltip[0], 'events').mouseout,
    ...
    test("should add position class before positioning so that position-specific styles are taken into account",
        function () {
            $("head").append(
            ...
            ok(Math.round(target.offset().top + target[0].offsetHeight / 2 - tooltip[0].offsetHeight / 2)
                === Math.round(tooltip.offset().top))
            target.tooltip('hide')
        })
    ...
    test("tooltip title test #2", function () {
        ...
        .tooltip('show')
        equal($('.tooltip').children('.tooltip-inner').text(), 'Simple tooltip',
    ...
    test("tooltip title test #3", function () {
        ...
        .tooltip('show')
        equal($('.tooltip').children('.tooltip-inner').text(), 'This is a tooltip with some content',
    ...
    test("tooltips should be placed dynamically, with the dynamic placement option", function () {
        ...
        var bottomTooltip = $(
            '<div style="display: inline-block; position: absolute; bottom: 0;" rel="tooltip" title="Bottom tooltip">Bottom Dynamic Tooltip</div>')
        .appendTo('#dynamic-tt-test')
