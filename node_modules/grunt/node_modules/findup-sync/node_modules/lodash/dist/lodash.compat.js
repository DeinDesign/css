    ...
    function isEqual(a, b, callback, thisArg, stackA, stackB) {
        ...
        forIn(b, function (value, key, b) {
            if (hasOwnProperty.call(b, key)) {
                ...
                return (result = hasOwnProperty.call(a, key) && isEqual(a[key], value, callback, thisArg, stackA,
                        stackB));
            }
        });
        ...
        outer:
            while (++index < length) {
                ...
                if (inited || indexOf(seen, value) < 0) {
                    ...
                    while (--argsIndex) {
                        if (!(cache[argsIndex] || (cache[argsIndex] = cachedContains(args[argsIndex], 0, 100)))(
                                value)) {
                            continue outer;
                        }
                    }
