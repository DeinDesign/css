   ...
   * });
    ...
    function isEqual(a, b, stackA, stackB) {
        ...
        if (hasDontEnumBug) {
            while (++index < 7) {
                key = shadowed[index];
                if (hasOwnProperty.call(a, key) && !(hasOwnProperty.call(b, key) && isEqual(a[key], b[key], stackA,
                        stackB))) {
                    return false;
                }
            }
   ...
   * }
    ...
    var isPlainObject = !getPrototypeOf ? shimIsPlainObject : function (value) {
            ...
            var valueOf = value.valueOf,
                objProto = typeof valueOf == 'function' && (objProto = getPrototypeOf(valueOf)) && getPrototypeOf(
                        objProto);
    ...
    function template(text, data, options) {
        ...
        text.replace(reDelimiters,
            function (match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
                ...
                isEvaluating || (isEvaluating = evaluateValue || reComplexDelimiter.test(
                        escapeValue || interpolateValue));
