        ...
        test: function test(testName, expected, callback, async) {
            ...
            synchronize(function () {
                ...
                if (config.expected && config.expected != config.assertions.length) {
                    QUnit.ok(false,
                        "Expected " + config.expected + " assertions, but " + config.assertions.length + " were run");
                }
                ...
                if (tests) {
                    ...
                    b.innerHTML = name + " <b style='color:black;'>(<b class='fail'>" + bad + "</b>, <b class='pass'>"
                        + good + "</b>, " + config.assertions.length + ")</b>";
...
// object exists, in that case we assume we're in CommonJS
    ...
    addEvent(window, "load", function () {
        ...
        if (toolbar) {
            ...
            addEvent(missing, "click", function () {
                var li = document.getElementsByTagName("li");
                for (var i = 0; i < li.length; i++) {
                    if (li[i].className.indexOf("fail") > -1 && li[i].innerHTML.indexOf(
                            'missing test - untested code is broken code') > -1) {
    ...
    function done() {
        ...
        var banner = id("qunit-banner"),
            ...
            html = ['Tests completed in ',
                ...
                '<span class="bad">', config.stats.all - config.stats.bad, '</span> tests of <span class="all">',
                config.stats.all, '</span> passed, ', config.stats.bad, ' failed.'].join('');
    ...
    function push(result, actual, expected, message) {
        ...
        QUnit.ok(result,
            result ? message + ": " + expected : message + ", expected: " + QUnit.jsDump.parse(expected) + " result: "
    ...
    Test.prototype = {
        ...
        finish: function () {
                ...
                addEvent(b, "dblclick", function (e) {
                    ...
                    if (window.location && target.nodeName.toLowerCase() === "strong") {
                        window.location.search = "?" + encodeURIComponent(
                                getText([target]).replace(/\(.+\)$/, "").replace(/(^\s*|\s*$)/g, ""));
                    }
                });
            ...
            try {
                ...
                // TODO use testName instead of name for no-markup message?
                fail("reset() failed, following Test " + this.name + ", exception and reset fn follows", e,
                    QUnit.reset);
            }
...
// define these after exposing globals to keep them in these QUnit namespace only
        ...
        if (banner) {
            ...
            if (paramsIndex > -1) {
                ...
                if (mainPageLocation == location.href) {
                    ...
                    banner.innerHTML = '<a href="' + mainPageLocation + '">' + banner.innerHTML
                        + '</a> &#8250; <a href="">' + testName + '</a>';
                }
            }
        }
    ...
    function done() {
        ...
        var banner = id("qunit-banner"),
            ...
            html = ['Tests completed in ',
                +new Date - config.started, ' milliseconds.<br/>',
                '<span class="passed">', config.stats.all - config.stats.bad, '</span> tests of <span class="total">',
                config.stats.all, '</span> passed, <span class="failed">', config.stats.bad, '</span> failed.'].join(
                '');
