$(document).ready(function () {
    ...
    test("arrays: uniq", function () {
        ...
        equals(_.map(_.uniq(list, false, iterator), iterator).join(', '), 'moe, curly, larry',
