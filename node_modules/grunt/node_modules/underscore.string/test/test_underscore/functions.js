$(document).ready(function () {
    ...
    test("functions: bind", function () {
        ...
        equal(new Boundf().hello, undefined,
    ...
    asyncTest("functions: throttle", 2, function () {
        ...
        _.delay(function () {
            ok(counter == 1, "incr was called immediately");
        }, 30);
        _.delay(function () {
            ok(counter == 4, "incr was throttled");
            start();
        }, 400);
    });
    ...
    asyncTest("functions: throttle arguments", 2, function () {
        ...
        _.delay(function () {
            equals(value, 1, "updated to latest value");
        }, 40);
        _.delay(function () {
            equals(value, 6, "updated to latest value");
            start();
        }, 400);
    });
    ...
    asyncTest("functions: throttle once", 1, function () {
        ...
        throttledIncr();
        _.delay(function () {
            ok(counter == 1, "incr was called once");
            start();
        }, 220);
    });
    ...
    asyncTest("functions: throttle twice", 1, function () {
        ...
        throttledIncr();
        _.delay(function () {
            ok(counter == 2, "incr was called twice");
            start();
        }, 220);
    });
    ...
    asyncTest("functions: debounce", 1, function () {
        ...
        _.delay(function () {
            ok(counter == 1, "incr was debounced");
            start();
        }, 220);
    });
