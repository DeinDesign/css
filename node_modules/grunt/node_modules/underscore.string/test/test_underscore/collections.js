$(document).ready(function () {
    ...
    test("collections: each", function () {
        ...
        equals(answers.join(", "), 'one, two, three',
    ...
    test('collections: map', function () {
        ...
        var ids = _.map($('div.underscore-test').children(), function (n) {
            return n.id;
        });
        ...
        var length = _.map(Array(2), function (v) {
            return v;
        }).length;
    ...
    test('collections: reduce', function () {
        ...
        sparseArray[0] = 20;
        sparseArray[2] = -5;
        equals(_.reduce(sparseArray, function (a, b) {
            return a - b;
        }), 25, 'initially-sparse arrays with no memo');
    });
    ...
    test('collections: reduceRight', function () {
        ...
        sparseArray[0] = 20;
        sparseArray[2] = -5;
        equals(_.reduceRight(sparseArray, function (a, b) {
            return a - b;
        }), -25, 'initially-sparse arrays with no memo');
    });
