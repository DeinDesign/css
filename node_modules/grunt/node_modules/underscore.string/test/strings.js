$(document).ready(function () {
    ...
    test("Strings: sprintf", function () {
        ...
        equals(_.sprintf("%(id)d - %(name)s", {id: 824, name: "Hello World"}), "824 - Hello World",
            'Named replacements work');
        equals(_.sprintf("%(args[0].id)d - %(args[1].name)s", {args: [{id: 824}, {name: "Hello World"}]}),
    ...
    test("Strings: vsprintf", function () {
        ...
        equals(_.vsprintf("%(id)d - %(name)s", [{id: 824, name: "Hello World"}]), "824 - Hello World",
            'Named replacement works');
        equals(_.vsprintf("%(args[0].id)d - %(args[1].name)s", [{args: [{id: 824}, {name: "Hello World"}]}]),
    ...
    test('String: humanize', function () {
        ...
        equals(_('the  humanize string method  ').humanize(), 'The humanize string method');
        equals(_('   capitalize dash-CamelCase_underscore trim  ').humanize(),
    ...
    test('Strings: stripTags', function () {
        ...
        equals(_('a <a href="#">link</a><script>alert("hello world!")</scr' + 'ipt>').stripTags(),
    ...
    test('Strings: toSentence', function () {
        ...
        equals(_.toSentence(['jQuery', 'MooTools', 'Prototype', 'YUI']), 'jQuery, MooTools, Prototype and YUI',
            'array with multiple elements');
        equals(_.toSentence(['jQuery', 'MooTools', 'Prototype'], ',', ' or '), 'jQuery,MooTools or Prototype',
            'handles custom separators');
    });

    test('Strings: slugify', function () {
        equals(_("Jack & Jill like numbers 1,2,3 and 4 and silly characters ?%.$!/").slugify(),
        ...
        equals(_("I am a word too, even though I am but a single letter: i!").slugify(),
