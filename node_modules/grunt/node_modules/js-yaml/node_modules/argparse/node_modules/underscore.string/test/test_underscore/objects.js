$(document).ready(function () {
    ...
    test("keys", function () {
        ...
        raises(function () {
            _.keys(null);
        }, TypeError, 'throws an error for `null` values');
        raises(function () {
            _.keys(void 0);
        }, TypeError, 'throws an error for `undefined` values');
        raises(function () {
            _.keys(1);
        }, TypeError, 'throws an error for number primitives');
        raises(function () {
            _.keys('a');
        }, TypeError, 'throws an error for string primitives');
        raises(function () {
            _.keys(true);
        }, TypeError, 'throws an error for boolean primitives');
    });
    ...
    test("pairs", function () {
        ...
        deepEqual(_.pairs({one: 1, two: 2, length: 3}), [['one', 1], ['two', 2], ['length', 3]],
