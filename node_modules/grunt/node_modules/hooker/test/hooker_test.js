...
exports['hook'] = {
    ...
    'pre- & post-hook': function (test) {
        ...
        test.strictEqual(this.add(2, 3), 6, "should return the original function's result.");
        test.deepEqual(this.order, ["before", 1, 2, 3, "add", 1, 2, 3, "after", 1, 2, 3, 6],
            "functions should execute in-order.");
        test.done();
    },
    ...
    'pre- & post-hook, return value override': function (test) {
        ...
        test.strictEqual(this.add(2, 3), "a1236",
            "should return the overridden result, and post-hook result should take precedence over pre-hook result.");
        test.deepEqual(this.order, ["before", 1, 2, 3, "add", 1, 2, 3, "after", 1, 2, 3, 6],
            "functions should execute in-order.");
        test.done();
    },
    ...
    'pre-hook, filtering arguments': function (test) {
        ...
        test.strictEqual(this.add(2, 3), "xyz",
            "should return the original function's result, given filtered context and arguments.");
    ...
    'pre- & post-hook, filtering arguments': function (test) {
        ...
        test.strictEqual(this.add(2, 3), "xyz",
            "should return the original function's result, given filtered context and arguments.");
        test.deepEqual(this.order, ["before", 1, 2, 3, "add", "x", "y", "z", "after", 1, 2, 3, "xyz"],
            "functions should execute in-order.");
        test.done();
    },
    ...
    'pre- & post-hook, preempt original function with value, return value override': function (test) {
        ...
        test.strictEqual(this.add(2, 3), "a1239000",
            "should return the overridden result, and post-hook result should take precedence over preempt value.");
        test.deepEqual(this.order, ["before", 1, 2, 3, "after", 1, 2, 3, 9000], "functions should execute in-order.");
        test.done();
    },
    'pre- & post-hook, some properties': function (test) {
        ...
        test.deepEqual(this.order, ["before", 1, 2, 3, "add1", 1, 2, 3, "after", 1, 2, 3, 6],
            "functions should execute in-order.");
        this.order = [];
        test.strictEqual(this.obj.add2(2, 3), 6, "should return the original function's result.");
        test.deepEqual(this.order, ["before", 1, 2, 3, "add2", 1, 2, 3, "after", 1, 2, 3, 6],
            "functions should execute in-order.");
        this.order = [];
    ...
    'pre- & post-hook, all properties': function (test) {
        ...
        this.order = [];
        test.strictEqual(this.obj.add3(2, 3), 6, "should return the original function's result.");
        test.deepEqual(this.order, ["before", 1, 2, 3, "add3", 1, 2, 3, "after", 1, 2, 3, 6],
            "functions should execute in-order.");
        test.done();
    },
    'pre- & post-hook, all properties, passName': function (test) {
        ...
        test.strictEqual(this.obj.add1(2, 3), 6, "should return the original function's result.");
        test.deepEqual(this.order, ["before", 1, "add1", 2, 3, "add1", 1, 2, 3, "after", 1, "add1", 2, 3, 6],
            "functions should execute in-order.");
        this.order = [];
        test.strictEqual(this.obj.add2(2, 3), 6, "should return the original function's result.");
        test.deepEqual(this.order, ["before", 1, "add2", 2, 3, "add2", 1, 2, 3, "after", 1, "add2", 2, 3, 6],
            "functions should execute in-order.");
        this.order = [];
        test.strictEqual(this.obj.add3(2, 3), 6, "should return the original function's result.");
        test.deepEqual(this.order, ["before", 1, "add3", 2, 3, "add3", 1, 2, 3, "after", 1, "add3", 2, 3, 6],
            "functions should execute in-order.");
        test.done();
    },
    ...
    'unhook some properties': function (test) {
        ...
        test.strictEqual(hooker.orig(this.obj, "add3"), undefined,
            "should not have been hooked, so should not have an original function");
