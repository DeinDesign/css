...
(function () {
    ...
    _ref1 = require(
        './helpers'), compact = _ref1.compact, flatten = _ref1.flatten, extend = _ref1.extend, merge = _ref1.merge, del = _ref1.del, starts = _ref1.starts, ends = _ref1.ends, last = _ref1.last;
    ...
    exports.Literal = Literal = (function (_super) {
        ...
        Literal.prototype.compileNode = function (o) {
            var code, _ref2;
            code = this.value === 'this' ? ((_ref2 = o.scope.method) != null ? _ref2.bound : void 0)
                    ? o.scope.method.context : this.value : this.value.reserved ? "\"" + this.value + "\"" : this.value;
            if (this.isStatement()) {
        ...
        Call.prototype.compileSplat = function (o, splatArgs) {
            ...
            if (this.isNew) {
                ...
                return "(function(func, args, ctor) {\n" + idt + "ctor.prototype = func.prototype;\n" + idt
                    ...
                    + (this.variable.compile(o, LEVEL_LIST)) + ", " + splatArgs + ", function(){})";
            }
    ...
    exports.Range = Range = (function (_super) {
        ...
        Range.prototype.compileVariables = function (o) {
            ...
            _ref5 = [this.fromVar.match(SIMPLENUM),
                this.toVar.match(SIMPLENUM)], this.fromNum = _ref5[0], this.toNum = _ref5[1];
            if (this.stepVar) {
        ...
        Range.prototype.compileNode = function (o) {
            ...
            condPart = this.stepNum ? +this.stepNum > 0 ? "" + lt + " " + this.toVar : "" + gt + " " + this.toVar
                : known ? ((_ref3 = [+this.fromNum, +this.toNum], from = _ref3[0], to = _ref3[1], _ref3), from <= to
                        ? "" + lt + " " + to : "" + gt + " " + to) : (cond = "" + this.fromVar + " <= " + this.toVar, ""
                    + cond + " ? " + lt + " " + this.toVar + " : " + gt + " " + this.toVar);
            stepPart = this.stepVar ? "" + idx + " += " + this.stepVar : known ? namedIndex ? from <= to ? "++" + idx
                            : "--" + idx : from <= to ? "" + idx + "++" : "" + idx + "--" : namedIndex ? "" + cond
                        + " ? ++" + idx + " : --" + idx : "" + cond + " ? " + idx + "++ : " + idx + "--";
            if (namedIndex) {
        ...
        Range.prototype.compileArray = function (o) {
            ...
            if (this.fromNum && this.toNum && Math.abs(this.fromNum - this.toNum) <= 20) {
                range = (function () {
                    _results = [];
                    for (var _i = _ref2 = +this.fromNum, _ref3 = +this.toNum;
                        _ref2 <= _ref3 ? _i <= _ref3 : _i >= _ref3; _ref2 <= _ref3 ? _i++ : _i--) {
                        _results.push(_i);
                    }
                    return _results;
                }).apply(this);
            ...
            return "(function() {" + pre + "\n" + idt + "for (" + body + ")" + post + "}).apply(this" + (args != null
                    ? args : '') + ")";
        };
    ...
    exports.Slice = Slice = (function (_super) {
        ...
        Slice.prototype.compileNode = function (o) {
            ...
            if (to && !(!this.range.exclusive && +compiled === -1)) {
                toStr = ', ' + (this.range.exclusive ? compiled : SIMPLENUM.test(compiled) ? "" + (+compiled + 1)
                            : (compiled = to.compile(o, LEVEL_ACCESS), "" + compiled + " + 1 || 9e9"));
            }
        ...
        Class.prototype.addBoundFunctions = function (o) {
            ...
            if (this.boundFuncs.length) {
                ...
                for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                    ...
                    _results.push(this.ctor.body.unshift(
                        new Literal("" + lhs + " = " + (utility('bind')) + "(" + lhs + ", this)")));
                }
                return _results;
            }
        };
    ...
    exports.Assign = Assign = (function (_super) {
        ...
        function Assign(variable, value, context, options) {
            ...
            forbidden = (_ref2 = (name = this.variable.unwrapAll().value), __indexOf.call(STRICT_PROSCRIBED, _ref2)
            >= 0);
        ...
        Assign.prototype.isStatement = function (o) {
            return (o != null ? o.level : void 0) === LEVEL_TOP && (this.context != null) && __indexOf.call(
                    this.context, "?") >= 0;
        };
        ...
        Assign.prototype.compileNode = function (o) {
            ...
            if (this.value instanceof Code && (match = METHOD_DEF.exec(name))) {
                ...
                this.value.name = (_ref3 = (_ref4 = (_ref5 = match[2]) != null ? _ref5 : match[3]) != null ? _ref4
                    : match[4]) != null ? _ref3 : match[5];
            }
        ...
        Assign.prototype.compilePatternMatch = function (o) {
            ...
            if (top && olen === 1 && !((obj = objects[0]) instanceof Splat)) {
                ...
                if (_ref5 = obj.unwrap().value, __indexOf.call(RESERVED, _ref5) >= 0) {
                    throw new SyntaxError("assignment to a reserved word: " + (obj.compile(o)) + " = " + (value.compile(
                            o)));
                }
            ...
            for (i = _i = 0, _len = objects.length; _i < _len; i = ++_i) {
                ...
                if ((name != null) && __indexOf.call(RESERVED, name) >= 0) {
                    throw new SyntaxError("assignment to a reserved word: " + (obj.compile(o)) + " = " + (val.compile(
                            o)));
                }
        ...
        Assign.prototype.compileConditional = function (o) {
            ...
            if (!left.properties.length && left.base instanceof Literal && left.base.value !== "this" && !o.scope.check(
                    left.base.value)) {
                throw new Error("the variable \"" + left.base.value + "\" can't be assigned with " + this.context
        ...
        Assign.prototype.compileSplice = function (o) {
            ...
            _ref3 = (from != null ? from.cache(o, LEVEL_OP) : void 0) || ['0',
                    '0'], fromDecl = _ref3[0], fromRef = _ref3[1];
            if (to) {
    ...
    exports.Op = Op = (function (_super) {
        ...
        Op.prototype.isChainable = function () {
            var _ref2;
            return (_ref2 = this.operator) === '<' || _ref2 === '>' || _ref2 === '>=' || _ref2 === '<=' || _ref2
                === '===' || _ref2 === '!==';
        };
        ...
        Op.prototype.invert = function () {
            ...
            if (this.isChainable() && this.first.isChainable()) {
                ...
                return new Parens(this).invert();
            } else if (this.operator === '!' && (fst = this.first.unwrap()) instanceof Op && ((_ref2 = fst.operator)
                === '!' || _ref2 === 'in' || _ref2 === 'instanceof')) {
                return fst;
            } else {
                return new Op('!', this);
            }
        ...
        Op.prototype.unfoldSoak = function (o) {
            var _ref2;
            return ((_ref2 = this.operator) === '++' || _ref2 === '--' || _ref2 === 'delete') && unfoldSoak(o, this,
                    'first');
        };
        ...
        Op.prototype.compileNode = function (o) {
            ...
            if (((_ref2 = this.operator) === '--' || _ref2 === '++')
                && (_ref3 = this.first.unwrapAll().value, __indexOf.call(STRICT_PROSCRIBED, _ref3) >= 0)) {
        ...
        Op.prototype.compileChain = function (o) {
            ...
            code = "" + fst + " " + (this.invert ? '&&' : '||') + " " + (shared.compile(o)) + " " + this.operator + " "
    ...
    exports.In = In = (function (_super) {
        ...
        In.prototype.compileLoopTest = function (o) {
            ...
            code = utility('indexOf') + (".call(" + (this.array.compile(o, LEVEL_LIST)) + ", " + ref + ") ")
                + (this.negated ? '< 0' : '>= 0');
            if (sub === ref) {
                return code;
            }
    ...
    exports.For = For = (function (_super) {
        ...
        function For(body, source) {
            ...
            this.range = this.source instanceof Value && this.source.base instanceof Range
        ...
        For.prototype.compileNode = function (o) {
            ...
            if (this.range) {
                ...
                if (!this.object) {
                    ...
                    stepPart = "" + kvarAssign + (this.step ? "" + ivar + " += " + stepvar : (kvar !== ivar ? "++"
                                + ivar : "" + ivar + "++"));
            ...
            if (this.object) {
                ...
                if (this.own) {
                    guardPart = "\n" + idt1 + "if (!" + (utility('hasProp')) + ".call(" + svar + ", " + kvar
                        + ")) continue;";
                }
            }
            ...
            return "" + defPart + (resultPart || '') + this.tab + "for (" + forPart + ") {" + guardPart + varPart + body
        ...
        For.prototype.pluckDirectCall = function (o, body) {
            ...
            for (idx = _i = 0, _len = _ref2.length; _i < _len; idx = ++_i) {
                ...
                if (!((val instanceof Code) || (val instanceof Value && ((_ref3 = val.base) != null ? _ref3.unwrapAll()
                        : void 0) instanceof Code && val.properties.length === 1
                    && ((_ref4 = (_ref5 = val.properties[0].name) != null ? _ref5.value : void 0) === 'call' || _ref4
                    === 'apply')))) {
                    continue;
                }
    ...
    exports.Switch = Switch = (function (_super) {
        ...
        Switch.prototype.compileNode = function (o) {
            ...
            code = this.tab + ("switch (" + (((_ref2 = this.subject) != null ? _ref2.compile(o, LEVEL_PAREN) : void 0)
                || false) + ") {\n");
            _ref3 = this.cases;
    ...
    exports.If = If = (function (_super) {
        ...
        If.prototype.isStatement = function (o) {
            ...
            return (o != null ? o.level : void 0) === LEVEL_TOP || this.bodyNode().isStatement(o)
                || ((_ref2 = this.elseBodyNode()) != null ? _ref2.isStatement(o) : void 0);
        };
        ...
        If.prototype.compileStatement = function (o) {
            ...
            return ifPart + ' else ' + (this.isChain
                    ? (o.indent = this.tab, o.chainChild = true, this.elseBody.unwrap().compile(o, LEVEL_TOP)) : "{\n"
    ...
    Closure = {
        ...
        literalThis: function (node) {
            return (node instanceof Literal && node.value === 'this' && !node.asKey) || (node instanceof Code
                && node.bound) || (node instanceof Call && node.isSuper);
        }
    };
