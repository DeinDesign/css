...
exports.less = {
    compile: function (test) {
        ...
        test.equal(expected, actual,
            'should compile less, with the ability to handle imported files from alternate include paths');
    ...
    yuicompress: function (test) {
        ...
        test.equal(expected, actual,
            'should yuicompress output when yuicompress option is true and concating is enable');
