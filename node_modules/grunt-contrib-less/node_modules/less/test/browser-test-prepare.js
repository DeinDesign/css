...
var createTestRunnerPage = function (dir, exclude, testSuiteName, dir2) {
    ...
    readDirFilesSync(path.join("test", dir, 'less', dir2 || ""), /\.less$/, function (file) {
        ...
        output += '<link id="original-less:' + id + '" rel="stylesheet/less" type="text/css" href="/' + path.join(dir,
                'less', dir2 || "", name) + '.less' + '">\n';
        output += '<link id="expected-less:' + id + '" rel="stylesheet"  type="text/css" href="/' + path.join(dir,
                'css', dir2 || "", name) + '.css' + '">\n';
    });
