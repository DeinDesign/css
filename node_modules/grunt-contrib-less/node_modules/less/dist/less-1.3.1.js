...
//
    less.Parser = function Parser(env) {
        ...
        if (!env.contents) {
            env.contents = {};
        }  // env.contents must be passed arround with top env
        ...
        return parser = {
            ...
            parsers: {
                ...
                mixin: {
                    ...
                    //
                    call: function () {
                        var elements = [], e, c, args = [], arg, index = i, s = input.charAt(
...
//
    ...
    (function (tree) {
        ...
        tree.URL.prototype = {
            ...
            eval: function (ctx) {
                ...
                if (typeof window !== 'undefined' && typeof val.value === "string" && !/^(?:[a-z-]+:|\/)/.test(
                        val.value) && this.paths.length > 0) {
    ...
    (function (tree) {
        ...
        tree.debugInfo.asMediaQuery = function (ctx) {
            return '@media -sass-debug-info{filename{font-family:"' + ctx.debugInfo.fileName + '";}line{font-family:"'
                    ...
                    new (less.Parser)({
                        ...
                        try {
                            callback(e, root, data, sheet,
                                {local: false, lastModified: lastModified, remaining: remaining});
