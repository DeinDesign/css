        ...
        tree.Import.prototype = {
            ...
            eval: function (env) {
                ...
                if (this.css) {
                    ...
                    return this.features ? new (tree.Directive)('@media', ruleset.rules, this.features.value)
                        : ruleset.rules;
                }
            }
        };
    ...
    (function (tree) {
        ...
        tree.URL = function (val, paths) {
            if (val.data) {
                ...
                if (typeof(window) !== 'undefined' && !/^(?:https?:\/\/|file:\/\/|data:|\/)/.test(val.value)
                    && paths.length > 0) {
