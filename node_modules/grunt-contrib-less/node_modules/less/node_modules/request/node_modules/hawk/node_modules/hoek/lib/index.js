...
exports.merge = function (target, source, isNullOverride /* = true */, isMergeArrays /* = true */) {
    ...
    exports.assert(source === null || source === undefined || typeof source === 'object',
...
exports.applyToDefaults = function (defaults, options) {
    ...
    exports.assert(!options || options === true || typeof options === 'object',
...
exports.formatStack = function (stack) {
    ...
    for (var i = 0, il = stack.length; i < il; ++i) {
        var item = stack[i];
        trace.push([item.getFileName(), item.getLineNumber(), item.getColumnNumber(), item.getFunctionName(),
            item.isConstructor()]);
    }
...
exports.toss = function (condition /*, [message], next */) {
    ...
    var err = (message instanceof Error ? message : (message ? new Error(message) : (condition instanceof Error
                ? condition : new Error())));
...
exports.escapeHeaderAttribute = function (attribute) {
    ...
    exports.assert(attribute.match(/^[ \w\!#\$%&'\(\)\*\+,\-\.\/\:;<\=>\?@\[\]\^`\{\|\}~\"\\]*$/),
