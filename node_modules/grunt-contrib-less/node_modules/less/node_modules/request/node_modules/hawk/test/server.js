    ...
    describe('server', function () {
        ...
        describe('#authenticate', function () {
            ...
            it('should parse a valid authentication header (sha1)', function (done) {
                ...
                Hawk.server.authenticate(req, credentialsFunc, {localtimeOffsetMsec: 1353788437000 - Hawk.utils.now()},
            ...
            it('should parse a valid authentication header (sha256)', function (done) {
                ...
                Hawk.server.authenticate(req, credentialsFunc, {localtimeOffsetMsec: 1353832234000 - Hawk.utils.now()},
                    function (err, credentials, artifacts) {
            ...
            it('should parse a valid authentication header (host override)', function (done) {
                ...
                Hawk.server.authenticate(req, credentialsFunc,
                    {host: 'example.com', localtimeOffsetMsec: 1353788437000 - Hawk.utils.now()},
                    function (err, credentials, artifacts) {
            ...
            it('should parse a valid authentication header (host port override)', function (done) {
                ...
                Hawk.server.authenticate(req, credentialsFunc,
                    {host: 'example.com', port: 8080, localtimeOffsetMsec: 1353788437000 - Hawk.utils.now()},
                    function (err, credentials, artifacts) {
            ...
            it('should parse a valid authentication header (POST with payload)', function (done) {
                ...
                Hawk.server.authenticate(req, credentialsFunc, {localtimeOffsetMsec: 1357926341000 - Hawk.utils.now()},
                    function (err, credentials, artifacts) {
            ...
            it('should fail on missing hash', function (done) {
                ...
                Hawk.server.authenticate(req, credentialsFunc,
                    {payload: 'body', localtimeOffsetMsec: 1353832234000 - Hawk.utils.now()},
                    function (err, credentials, artifacts) {
