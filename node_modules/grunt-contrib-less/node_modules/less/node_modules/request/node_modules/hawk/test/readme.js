    ...
    describe('README', function () {
        ...
        describe('core', function () {
            ...
            it('should generate a header protocol example (with payload)', function (done) {
                ...
                var header = Hawk.client.header('http://example.com:8000/resource/1?b=1&a=2', 'POST',
                    payloadOptions).field;
            ...
            it('should generate a normalized string protocol example (with payload)', function (done) {
                ...
                var normalized = Hawk.crypto.generateNormalizedString('header', {
                    ...
                    host: 'example.com',
                    port: 8000,
                    hash: Hawk.crypto.calculatePayloadHash(payloadOptions.payload, credentials.algorithm,
                        payloadOptions.contentType),
                    ext: options.ext
                });
