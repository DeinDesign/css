$(document).ready(function () {
    ...
    test('Strings: sprintf', function () {
        ...
        equal(_.sprintf('%(id)d - %(name)s', {id: 824, name: 'Hello World'}), '824 - Hello World',
            'Named replacements work');
        equal(_.sprintf('%(args[0].id)d - %(args[1].name)s', {args: [{id: 824}, {name: 'Hello World'}]}),
            '824 - Hello World', 'Named replacements with arrays work');
    });
    ...
    test('Strings: vsprintf', function () {
        ...
        equal(_.vsprintf('%(id)d - %(name)s', [{id: 824, name: 'Hello World'}]), '824 - Hello World',
            'Named replacement works');
        equal(_.vsprintf('%(args[0].id)d - %(args[1].name)s', [{args: [{id: 824}, {name: 'Hello World'}]}]),
            '824 - Hello World', 'Named replacement with arrays works');
    });
    ...
    test('Strings: endsWith', function () {
        ...
        ok(_.endsWith('00018-0000062.Plone.sdh264.1a7264e6912a91aa4a81b64dc5517df7b8875994.mp4', 'mp4'),
            'endsWith .mp4');
    ...
    test('String: humanize', function () {
        ...
        equal(_('the  humanize string method  ').humanize(), 'The humanize string method');
        equal(_('   capitalize dash-CamelCase_underscore trim  ').humanize(),
    ...
    test('Strings: stripTags', function () {
        ...
        equal(_('a <a href="#">link</a><script>alert("hello world!")</scr' + 'ipt>').stripTags(),
    ...
    test('Strings: toSentence', function () {
        ...
        equal(_.toSentence(['jQuery', 'MooTools', 'Prototype', 'YUI']), 'jQuery, MooTools, Prototype and YUI',
            'array with multiple elements');
        equal(_.toSentence(['jQuery', 'MooTools', 'Prototype'], ',', ' or '), 'jQuery,MooTools or Prototype',
    ...
    test('Strings: slugify', function () {
        equal(_('Jack & Jill like numbers 1,2,3 and 4 and silly characters ?%.$!/').slugify(),
            'jack-jill-like-numbers-123-and-4-and-silly-characters');
        equal(_('Un éléphant à l\'orée du bois').slugify(), 'un-elephant-a-loree-du-bois');
        equal(_('I know latin characters: á í ó ú ç ã õ ñ ü ă ș ț').slugify(),
            'i-know-latin-characters-a-i-o-u-c-a-o-n-u-a-s-t');
        equal(_('I am a word too, even though I am but a single letter: i!').slugify(),
    ...
    test('String: toBoolean', function () {
        ...
        strictEqual(_.toBoolean(function () {
        }), true);
