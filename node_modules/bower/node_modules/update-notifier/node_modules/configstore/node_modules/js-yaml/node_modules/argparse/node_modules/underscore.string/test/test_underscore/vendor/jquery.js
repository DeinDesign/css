        ...
        jQuery(function () {
            ...
            if (window.getComputedStyle) {
                ...
                support.reliableMarginRight =
                    ( parseInt(( window.getComputedStyle(marginDiv, null) || {marginRight: 0} ).marginRight, 10) || 0 )
                    === 0;
            }
            ...
            select: {
                get: function (elem) {
                    ...
                    for (; i < max; i++) {
                        ...
                        if (option.selected && (jQuery.support.optDisabled ? !option.disabled : option.getAttribute(
                                    "disabled") === null) &&
    ...
    jQuery.event = {
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default.apply(elem.ownerDocument, data) === false) && !(type
                    ...
                    if (ontype && elem[type] && ((type !== "focus" && type !== "blur") || event.target.offsetWidth
                        !== 0) && !jQuery.isWindow(elem)) {
        ...
        mouseHooks: {
            ...
            filter: function (event, original) {
                ...
                if (event.pageX == null && original.clientX != null) {
                    ...
                    event.pageY = original.clientY + ( doc && doc.scrollTop || body && body.scrollTop || 0 ) - ( doc
            ...
            if (toString.call(checkSet) === "[object Array]") {
                if (!prune) {
                    ...
                    for (i = 0; checkSet[i] != null; i++) {
                        if (checkSet[i] && (checkSet[i] === true || checkSet[i].nodeType === 1 && Sizzle.contains(
                                context, checkSet[i]))) {
                            results.push(set[i]);
                        }
                    }
        ...
        var Expr = Sizzle.selectors = {
            ...
            filters: {
                ...
                text: function (elem) {
                    ...
                    return elem.nodeName.toLowerCase() === "input" && "text" === type && ( attr === type || attr
                        === null );
                },
            ...
            filter: {
                ...
                TAG: function (elem, match) {
                    return (match === "*" && elem.nodeType === 1) || !!elem.nodeName && elem.nodeName.toLowerCase()
                        === match;
                },
            ...
            if (document.getElementById(id)) {
                Expr.find.ID = function (match, context, isXML) {
                    if (typeof context.getElementById !== "undefined" && !isXML) {
                        ...
                        return m ?
                            m.id === match[1] || typeof m.getAttributeNode !== "undefined" && m.getAttributeNode(
                                "id").nodeValue === match[1] ?
                                [m] :
                                undefined :
                            [];
                    }
...
// IE can't serialize <link> and <script> tags normally
    ...
    jQuery.fn.extend({
        ...
        html: function (value) {
            return jQuery.access(this, function (value) {
                ...
                if (typeof value === "string" && !rnoInnerhtml.test(value) &&
                    ( jQuery.support.leadingWhitespace || !rleadingWhitespace.test(value) ) && !wrapMap[( rtagName.exec(
                        value) || ["", ""] )[1].toLowerCase()]) {
        ...
        domManip: function (args, table, callback) {
            ...
            if (!jQuery.support.checkClone && arguments.length === 3 && typeof value === "string" && rchecked.test(
                    value)) {
                return this.each(function () {
            ...
            if (this[0]) {
                ...
                if (jQuery.support.parentNode && parent && parent.nodeType === 11 && parent.childNodes.length
                    === this.length) {
    ...
    jQuery.extend({
        clone: function (elem, dataAndEvents, deepDataAndEvents) {
            var srcElements,
                ...
                clone = jQuery.support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test(
                    "<" + elem.nodeName + ">") ?
                    elem.cloneNode(true) :
                    shimCloneNode(elem);
        ...
        clean: function (elems, context, fragment, scripts) {
            ...
            if (fragment) {
                ...
                for (i = 0; ret[i]; i++) {
                    script = ret[i];
                    if (scripts && jQuery.nodeName(script, "script") && (!script.type || rscriptType.test(
                            script.type))) {
...
// Detect, normalize options and install callbacks for jsonp requests
    jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
        ...
        var inspectData = ( typeof s.data === "string" ) && /^application\/x\-www\-form\-urlencoded/.test(
                s.contentType);
            ...
            if (speed || speed === 0) {
                ...
                for (var i = 0, j = this.length; i < j; i++) {
                    ...
                    if (elem.style) {
                        ...
                        // for such an element
                        if ((display === "" && jQuery.css(elem, "display") === "none") || !jQuery.contains(
            ...
            function doAnimation() {
                ...
                for (p in prop) {
                    ...
                    if (rfxtypes.test(val)) {
                        ...
                        method = jQuery._data(this, "toggle" + p) || ( val === "toggle" ? hidden ? "show" : "hide"
                                : 0 );
                        if (method) {
...
// Generate shortcuts for custom animations
    ...
    jQuery.fx.prototype = {
        ...
        hide: function () {
            // Remember where we started, so that we can go back to it later
            this.options.orig[this.prop] = jQuery._data(this.elem, "fxshow" + this.prop) || jQuery.style(this.elem,
                    this.prop);
        ...
        step: function (gotoEnd) {
            ...
            if (gotoEnd || t >= options.duration + this.startTime) {
                ...
                if (options.duration == Infinity) {
                    ...
                    this.pos = jQuery.easing[options.animatedProperties[this.prop]](this.state, n, 0, 1,
                        options.duration);
    ...
    jQuery.fn.extend({
        ...
        offsetParent: function () {
            return this.map(function () {
                ...
                while (offsetParent && (!rroot.test(offsetParent.nodeName) && jQuery.css(offsetParent, "position")
                === "static")) {
