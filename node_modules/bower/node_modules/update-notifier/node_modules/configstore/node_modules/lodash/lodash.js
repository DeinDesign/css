...
;(function () {
        ...
        (function () {
            ...
            while (length--) {
                ...
                for (var className in nonEnumProps) {
                    if (hasOwnProperty.call(nonEnumProps, className) && !hasOwnProperty.call(nonEnumProps[className],
                            key)) {
     ...
     * });
        ...
        (function () {
             ...
             * @type boolean
             */
            support.enumErrorProps = propertyIsEnumerable.call(errorProto, 'message') || propertyIsEnumerable.call(
                    errorProto, 'name');
                ...
                if (partialRightArgs || isCurry) {
                    ...
                    if (isCurry && args.length < arity) {
                        ...
                        return baseCreateWrapper(
                            [func, (isCurryBound ? bitmask : bitmask & ~3), args, null, thisArg, arity]);
                    }
                }
                args || (args = arguments);
                if (isBindKey) {
        ...
        function baseIsEqual(a, b, callback, isWhere, stackA, stackB) {
            ...
            if (!isArr) {
                ...
                if (aWrapped || bWrapped) {
                    return baseIsEqual(aWrapped ? a.__wrapped__ : a, bWrapped ? b.__wrapped__ : b, callback, isWhere,
                        stackA, stackB);
                }
                ...
                if (ctorA != ctorB && !(isFunction(ctorA) && ctorA instanceof ctorA && isFunction(ctorB) && ctorB
                    instanceof ctorB) &&
            ...
            if (isArr) {
                ...
                forIn(b, function (value, key, b) {
                    if (hasOwnProperty.call(b, key)) {
                        ...
                        return (result = hasOwnProperty.call(a, key) && baseIsEqual(a[key], value, callback, isWhere,
                                stackA, stackB));
                    }
                });
     ...
     * });
        ...
        function flatten(array, isShallow, callback, thisArg) {
            ...
            if (typeof isShallow != 'boolean' && isShallow != null) {
                thisArg = callback;
                callback = (typeof isShallow != 'function' && thisArg && thisArg[isShallow] === array) ? null
                    : isShallow;
                isShallow = false;
            }
            if (callback != null) {
     ...
     *   };\
        ...
        function template(text, data, options) {
            ...
            var sourceURL = '\n/*\n//# sourceURL=' + (options.sourceURL || '/lodash/template/source['
                + (templateCounter++) + ']') + '\n*/';
