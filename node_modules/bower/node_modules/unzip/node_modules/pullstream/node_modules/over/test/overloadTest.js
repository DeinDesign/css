...
module.exports = {
    ...
    'optional parameter, invalid args': function (test) {
        var called = 0;
        var fn = overload([
            [overload.funcOptional, function () {
                called++;
            }]
        ]);
        try {
    ...
    'multiple overloads, valid args': function (test) {
        ...
        var fn = overload([
            [overload.number, function (n) {
                test.fail('this function should not be called');
            }],
    ...
    'multiple optionals': function (test) {
        ...
        var args;
        var fn = overload([
            [overload.string, overload.arrayOptionalWithDefault(null), overload.callbackOptional,
                function (str, arr, callback) {
                    args = arguments;
                    called++;
                }]
        ]);
