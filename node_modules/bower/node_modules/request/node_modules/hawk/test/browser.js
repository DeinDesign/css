...
describe('Browser', function () {
    ...
    it('should generate a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
                ...
                expect(Browser.client.authenticate(res, credentials, artifacts, {payload: 'some reply'})).to.equal(
                    true);
                done();
            });
        });
    ...
    it('should generate a header with stale ts and successfully authenticate on second call (manual localStorage)',
        function (done) {
    ...
    describe('client', function () {
        ...
        describe('#header', function () {
            ...
            it('should return an empty authorization header on invalid credentials', function (done) {
                ...
                var header = Browser.client.header('https://example.net/somewhere/over/the/rainbow', 'POST',
                    {credentials: credentials, ext: 'Bazinga!', timestamp: 1353809207}).field;
                expect(header).to.equal('');
                done();
            });
