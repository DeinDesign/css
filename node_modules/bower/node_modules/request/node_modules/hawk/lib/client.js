...
exports.authenticate = function (res, credentials, artifacts, options) {
    ...
    var calculatedHash = Crypto.calculatePayloadHash(options.payload, credentials.algorithm,
...
exports.getBewit = function (uri, options) {
    ...
    if (!uri ||
        (typeof uri !== 'string' && typeof uri !== 'object') || !options ||
        typeof options !== 'object' || !options.ttlSec) {
