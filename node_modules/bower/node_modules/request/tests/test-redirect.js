...
s.listen(s.port, function () {
    ...
    // Prevent bouncing.
    request({uri: server + '/nope', jar: jar, headers: {cookie: 'foo=bar'}, followRedirect: false},
        function (er, res, body) {
            if (er) {
                throw er
            }
            if (res.statusCode !== 302) {
                throw new Error('Status is not 302: ' + res.statusCode)
            }
    ...
    request.post(server + '/temp', {jar: jar, headers: {cookie: 'foo=bar'}}, function (er, res, body) {
        ...
        if (res.statusCode !== 301) {
            throw new Error('Status is not 301: ' + res.statusCode)
        }
        assert.ok(hits.temp, 'Original request is to /temp')
    ...
    request.post({uri: server + '/temp', followAllRedirects: true, jar: jar, headers: {cookie: 'foo=bar'}},
        function (er, res, body) {
            if (er) {
                throw er
            }
    ...
    request.post({uri: server + '/temp', followAllRedirects: false, jar: jar, headers: {cookie: 'foo=bar'}},
        function (er, res, body) {
            if (er) {
                throw er
            }
    ...
    request.del(server + '/temp', {jar: jar, headers: {cookie: 'foo=bar'}}, function (er, res, body) {
        ...
        if (res.statusCode < 301) {
            throw new Error('Status is not a redirect.')
        }
        assert.ok(hits.temp, 'Original request is to /temp')
    ...
    request.del(server + '/temp', {followRedirect: true, jar: jar, headers: {cookie: 'foo=bar'}},
        function (er, res, body) {
            if (er) {
                throw er
            }
    ...
    request.del(server + '/temp', {followAllRedirects: true, jar: jar, headers: {cookie: 'foo=bar'}},
        function (er, res, body) {
            if (er) {
                throw er
            }
