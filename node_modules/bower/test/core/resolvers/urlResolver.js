...
describe('UrlResolver', function () {
    ...
    describe('.resolve', function () {
        ...
        it('should extract if source is an archive and not rename to index if inside it\'s just a just bower.json/component.json file in it',
            function (next) {
                var resolver;
        ...
        describe('content-disposition validation', function () {
            ...
            it('should not work if the filename contain chars other than alphanumerical, dashes, spaces and dots',
                function (next) {
