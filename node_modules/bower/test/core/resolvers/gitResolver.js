...
describe('GitResolver', function () {
    ...
    describe('.hasNew', function () {
        ...
        it('should be true when resolved to the same tag (with different commit hash) for a given range',
            function (next) {
                var resolver;
    ...
    describe('._findResolution', function () {
        ...
        it('should resolve "*" to the latest commit on master if a repository has no valid semver tags',
            function (next) {
                var resolver;
