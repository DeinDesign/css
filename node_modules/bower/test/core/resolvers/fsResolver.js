...
describe('FsResolver', function () {
    ...
    describe('.resolve', function () {
        ...
        it('should not rename to index if source is a folder with just bower.json/component.json file in it',
            function (next) {
                var resolver;
                ...
                .then(copy.copyFile.bind(copy, path.join(testPackage, 'bower.json'),
