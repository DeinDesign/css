...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/lodash.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/lodash.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/lodash.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/lodash.html</h4>  <h4>
          <strong>Dest filename:</strong> lodash.html
        </h4>
          <h4><strong>Dest basename:</strong> lodash</h4>  <h4>
          <strong>Page title:</strong> Assemble
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <hr>
        <h1>Assemble</h1>
        <p>Static site generator for Grunt.js and Yeoman. Assemble makes it dead simple to build modular sites, blogs,
          gh-pages, components and documentation from reusable templates and data.</p>
        <div class="docs-header" id="content">
          <h1>Content</h1>
        </div>
        <ul>
