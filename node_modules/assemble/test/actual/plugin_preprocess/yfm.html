...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/yfm.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/yfm.html</h4>  <h4>
          <strong>Dest filename:</strong> yfm.html
        </h4>
          <h4><strong>Dest basename:</strong> yfm</h4>  <h4>
          <strong>Page title:</strong> YFM
        </h4>
        </div>
        <hr>
        <div class="row">
