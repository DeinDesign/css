...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/debug-helpers.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/debug-helpers.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/debug-helpers.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/debug-helpers.html</h4>  <h4>
          <strong>Dest filename:</strong> debug-helpers.html
        </h4>
          <h4><strong>Dest basename:</strong> debug-helpers</h4>  <h4>
          <strong>Page title:</strong> Debug Helper
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <p>Uncomment the <code>debug</code> helper below, run <code>grunt assemble</code>, and watch the output in the
          command line to see how it works.</p>
        <div class="docs-header" id="content">
          <h1>Content</h1>
        </div>
        <ul>
