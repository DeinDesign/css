...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/alert.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/alert.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/alert.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/alert.html</h4>  <h4>
          <strong>Dest filename:</strong> alert.html
        </h4>
          <h4><strong>Dest basename:</strong> alert</h4>  <h4>
          <strong>Page title:</strong> Title for &quot;alert.hbs&quot;
        </h4>
        </div>
        <hr>
        <div class="row">
          ...
          <pre><code class="json">
{
  ...
  "page": "<!DOCTYPE html>\n  <html lang=\"en\">\n  <head>\n    <meta charset=\"UTF-8\">\n    <title>Layout filename: '{{layout}}'</title>\n    <link
            ...
            <!-- Column: content -->\n        <div class=\"col-md-9\" role=\"main\">\n          <div
              ...
              class=\"col-md-6\">\n                {{#if tags}}\n                  {{> collections-tags }}\n                {{/if}}\n              </div>\n            </div>\n\n            <hr>\n\n            \n\n<h2>{{{title}}}</h2>\n<div
              class=\"alert alert-info\">{{{one.two}}}</div>\n\n\n            <div class=\"docs-header\" id=\"content\">\n              <h1>Content</h1>\n            </div>\n            <ul>\n            {{#each pages}}\n              <li> <a
