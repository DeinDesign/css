...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm-context.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/yfm-context.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm-context.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/yfm-context.html</h4>  <h4>
          <strong>Dest filename:</strong> yfm-context.html
        </h4>
          <h4><strong>Dest basename:</strong> yfm-context</h4>  <h4>
          <strong>Page title:</strong> This title is from the YFM of the current page
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <hr>
        <div class="page-header">
          <h1>This title is from the YFM of the current page</h1>
          <p class="lead">This description is from the YFM of the current page</p>
        </div>
        <hr>
        <div class="page-header">
          <h1>This title is from the YFM of the current page</h1>
          ...
          <pre><code class="json">
{
  ...
  "page": "<!DOCTYPE html>\n  <html lang=\"en\">\n  <head>\n    <meta charset=\"UTF-8\">\n    <title>Layout filename: '{{layout}}'</title>\n    <link
            ...
            <!-- Column: content -->\n        <div class=\"col-md-9\" role=\"main\">\n          <div
              ...
              class=\"lead\">{{{default home.description \"Description from home.json didn't render.\"}}}</p>\n</div>\n\n<hr>\n\n<div
              class=\"page-header\">\n  <h1>{{{default page.title \"page.title didn't render.\"}}}</h1>\n  <p
              class=\"lead\">{{{default page.description \"page.description didn't render.\"}}}</p>\n</div>\n\n<hr>\n\n<div
