...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/md-helper.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/md-helper.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/md-helper.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/md-helper.html</h4>  <h4>
          <strong>Dest filename:</strong> md-helper.html
        </h4>
          <h4><strong>Dest basename:</strong> md-helper</h4>  <h4>
          <strong>Page title:</strong> md helper
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <div class="page-header">
          <h1>md helper</h1>
          <p class="lead">Use the {{md}} helper to include external markdown files.</p>
        </div>
        <p>
        <hr>
        <h2 id="title-markdown">title: Markdown</h2>
