...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/collections-pages.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/collections-pages.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/collections-pages.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/collections-pages.html</h4>  <h4>
          <strong>Dest filename:</strong> collections-pages.html
        </h4>
          <h4><strong>Dest basename:</strong> collections-pages</h4>  <h4>
          <strong>Page title:</strong> Pages Collection
        </h4>
        </div>
        <hr>
        <div class="row">
