...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/context.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/context.html</strong>
      </h4>
    </div>
    <hr>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="bs-sidebar hidden-print" role="complementary">
        ...
        <ul class="nav nav-pills nav-stacked">
          ...
          <li><a href="debug-helpers.html">1</a></li>
          <li><a href="alert.html">2</a></li>
          <li><a href="collections-pages.html">3</a></li>
          <li><a href="collections-tags.html">4</a></li>
          <li><a href="collections.html">5</a></li>
          <li><a href="complex.html">6</a></li>
          <li class="active">
            <a href="context.html">7</a>
          </li>
          <li><a href="collections-categories.html">8</a></li>
          <li><a href="example.html">9</a></li>
          <li><a href="gist-helper.html">10</a></li>
          <li><a href="lodash.html">11</a></li>
          <li><a href="md-helper.html">12</a></li>
          <li><a href="no-yfm.html">13</a></li>
          <li><a href="yfm-context.html">14</a></li>
          <li><a href="yfm.html">15</a></li>
          <li class="next">
            <a href="collections-categories.html">Next &rarr;</a>
          </li>
          <li class="next">
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          <h4><strong>Page layout:</strong> preprocess.hbs</h4>  <h4>
          <strong>Page src:</strong> test/fixtures/pages/context.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/context.html</h4>  <h4>
          <strong>Dest filename:</strong> context.html
        </h4>
          <h4><strong>Dest basename:</strong> context</h4>  <h4>
          <strong>Page title:</strong> Context
        </h4>
        </div>
        <hr>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                <h4>categories on this page:
                  <span class="badge badge-info">3</span>
                </h4>
              </div>
              <div class="panel-body">
                <span class="label label-info">context</span>
                <span class="label label-info">pages
                    </span>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <span class="label label-info">collections
                    </span>
                <span class="label label-info">components</span>
                <span class="label label-info">context
                    </span>
                <span class="label label-info">fixtures</span>
                <span class="label label-info">helper
                    </span>
                <span class="label label-info">markdown</span>
                <span class="label label-info">one
                    </span>
                <span class="label label-info">pages</span>
                <span class="label label-info">three
                    </span>
                <span class="label label-info">two</span>
                <span class="label label-info">yaml
                    </span>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <div>Related pages for: <span class="label label-info">categories</span>
                </div>
                <ul class="links">
                  <li><a href="collections-categories.html">collections-categories.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">collections</span>
                </div>
                <ul class="links">
                  <li><a href="collections-categories.html">collections-categories.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">components</span>
                </div>
                <ul class="links">
                  <li><a href="alert.html">alert.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">context</span>
                </div>
                <ul class="links">
                  <li class="active">
                ...
                <div>Related pages for: <span class="label label-info">fixtures</span>
                </div>
                <ul class="links">
                  <li class="active">
                    <a href="context.html">context.html</a>
                ...
                <div>Related pages for: <span class="label label-info">helper</span>
                </div>
                <ul class="links">
                  <li><a href="md-helper.html">md-helper.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">markdown</span>
                </div>
                <ul class="links">
                  <li><a href="md-helper.html">md-helper.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">one</span>
                </div>
                <ul class="links">
                  <li><a href="collections-categories.html">collections-categories.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">pages</span>
                </div>
                <ul class="links">
                ...
                <div>Related pages for: <span class="label label-info">three</span>
                </div>
                <ul class="links">
                  <li><a href="collections-categories.html">collections-categories.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">two</span>
                </div>
                <ul class="links">
                  <li><a href="collections-categories.html">collections-categories.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">yaml</span>
                </div>
                <ul class="links">
                  <li><a href="example.html">example.html</a></li>
                  <li><a href="yfm-context.html">yfm-context.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-info">yfm</span>
                </div>
                <ul class="links">
                  <li><a href="example.html">example.html</a></li>
                  <li><a href="yfm-context.html">yfm-context.html</a></li>
          ...
          <div class="col-md-6">
            ...
            <div class="panel panel-success">
              ...
              <div class="panel-body">
                <div>Related pages for: <span class="label label-success">alert</span>
                </div>
                <ul class="links">
                  <li><a href="alert.html">alert.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">bootstrap</span>
                </div>
                <ul class="links">
                  <li><a href="alert.html">alert.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">collections</span>
                </div>
                <ul class="links">
                  <li><a href="collections-tags.html">collections-tags.html</a></li>
                  <li><a href="collections.html">collections.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">complex</span>
                </div>
                <ul class="links">
                  <li><a href="complex.html">complex.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">example</span>
                </div>
                <ul class="links">
                  <li><a href="example.html">example.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">examples</span>
                </div>
                <ul class="links">
                  <li><a href="complex.html">complex.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">markdown</span>
                </div>
                <ul class="links">
                  <li><a href="md-helper.html">md-helper.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">md</span>
                </div>
                <ul class="links">
                  <li><a href="md-helper.html">md-helper.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">one</span>
                </div>
                <ul class="links">
                  <li><a href="collections-tags.html">collections-tags.html</a></li>
                  <li><a href="collections.html">collections.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">pages</span>
                </div>
                <ul class="links">
                  <li><a href="collections-pages.html">collections-pages.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">tags</span>
                </div>
                <ul class="links">
                  <li><a href="collections-tags.html">collections-tags.html</a></li>
                  <li><a href="collections.html">collections.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">test</span>
                </div>
                <ul class="links">
                  <li><a href="md-helper.html">md-helper.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">tests</span>
                </div>
                <ul class="links">
                  <li><a href="complex.html">complex.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">three</span>
                </div>
                <ul class="links">
                  <li><a href="collections-tags.html">collections-tags.html</a></li>
                </ul>
                <div>Related pages for: <span class="label label-success">two</span>
                </div>
                <ul class="links">
                  <li><a href="collections-tags.html">collections-tags.html</a></li>
                </ul>
        ...
        <p>If a list item is empty, or rather only has a label and no link, then the variable did not populate a
          value.</p>
        <ul class="context-test">
          <li><a href="#" data-context="title">Context</a></li>
          <li><a href="#" data-context="this.title">Context</a></li>
          <li><a href="#" data-context="page.title">Context</a></li>
        ...
        <ul class="context-test">
          ...
          <li><a href="#" data-context="page.basename">context</a></li>
          ...
          <pre><code class="json">
{
  ...
  "page": "<!DOCTYPE html>\n  <html lang=\"en\">\n  <head>\n    <meta charset=\"UTF-8\">\n    <title>Layout filename: '{{layout}}'</title>\n    <link
            rel=\"stylesheet\" href=\"http://getbootstrap.com/dist/css/bootstrap.min.css\">\n    <link
            rel=\"stylesheet\" href=\"{{assets}}/validation.css\">\n  </head>\n  <body style=\"padding-top: 60px;\">\n    <div
            class=\"container\">\n\n      <!-- validate assets path -->\n      <section id=\"validate\"></section>\n      <div
            class=\"docs-section\">\n        <div class=\"docs-header\" id=\"content\">\n          <h4><strong
            class=\"text-muted\">{{page.src}}</strong> &#x2192; <strong
            class=\"text-success\">{{page.dest}}</strong></h4>\n        </div>\n        <hr>\n      </div>\n\n      {{pager pagination}}\n      <hr>\n\n      <div
            class=\"row\">\n        <!-- Column: sidebar -->\n        <div class=\"col-md-3\">\n          <div
            ...
            \n</style>\n\n<p>If a list item is empty, or rather only has a label and no link, then the variable did not populate a value.</p>\n\n<ul
              ...
              href=\"#\" data-context=\"this.title\">{{this.title}}</a></li>\n  <li><a href=\"#\"
                                                                                       data-context=\"page.title\">{{page.title}}</a></li>\n  <li><a
              href=\"#\" data-context=\"data.title\">{{data.title}}</a></li>\n</ul>\n\n<hr>\n\n<ul
              class=\"context-test\">\n  <li><a href=\"#\" data-context=\"basename\">{{basename}}</a></li>\n  <li><a
              href=\"#\" data-context=\"this.basename\">{{this.basename}}</a></li>\n  <li><a href=\"#\"
                                                                                             data-context=\"page.basename\">{{page.basename}}</a></li>\n  <li><a
              href=\"#\" data-context=\"data.basename\">{{data.basename}}</a></li>\n</ul>\n\n<hr>\n\n<ul
              class=\"context-test\">\n{{#each pages}}\n  <li><a href=\"#\"
                                                                 data-context=\"basename\">{{basename}}</a></li>\n  <li><a
              href=\"#\" data-context=\"../basename\">{{../basename}}</a></li>\n  <li><a href=\"#\"
                                                                                         data-context=\"this.basename\">{{this.basename}}</a></li>\n  <li><a
              href=\"#\" data-context=\"page.basename\">{{page.basename}}</a></li>\n  <li><a href=\"#\"
                                                                                             data-context=\"data.basename\">{{data.basename}}</a></li>\n{{/each}}\n</ul>\n\n<hr>\n\n<ul
              class=\"context-test\">\n{{#each pages}}\n  <li><a href=\"#\" data-context=\"title\">{{title}}</a></li>\n  <li><a
              href=\"#\" data-context=\"../title\">{{../title}}</a></li>\n  <li><a href=\"#\"
                                                                                   data-context=\"this.title\">{{this.title}}</a></li>\n  <li><a
              href=\"#\" data-context=\"page.title\">{{page.title}}</a></li>\n  <li><a href=\"#\"
                                                                                       data-context=\"data.title\">{{data.title}}</a></li>\n{{/each}}\n</ul>\n\n\n            <div
              class=\"docs-header\" id=\"content\">\n              <h1>Content</h1>\n            </div>\n            <ul>\n            {{#each pages}}\n              <li><a
              href=\"{{relative ../page.dest dest}}\">{{filename}}</a></li>\n            {{/each}}\n            </ul>\n\n            <hr>\n            <div
              style=\"display: none\">\n\n              <h1>Page</h1>\n              <h1>Each pages</h1>\n              <ul>\n                {{#each pages}}<li><a
              href=\"{{relativeLink}}\" class=\"{{#isCurrentPage}}active{{/isCurrentPage}}\">{{basename}}</a> </li>\n
