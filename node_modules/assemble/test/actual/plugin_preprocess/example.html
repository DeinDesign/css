...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/example.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/plugin_preprocess/example.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/example.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/plugin_preprocess/example.html</h4>  <h4>
          <strong>Dest filename:</strong> example.html
        </h4>
          <h4><strong>Dest basename:</strong> example</h4>  <h4>
          <strong>Page title:</strong> Title from YFM of &quot;example.hbs&quot;
        </h4>
        </div>
        <hr>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <span class="label label-info">yfm
                    </span>
              </div>
            </div>
            <hr>
