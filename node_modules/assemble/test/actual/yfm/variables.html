...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm/variables.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/yfm/variables.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-3">
      <div class="bs-sidebar hidden-print" role="complementary">
        ...
        <ul class="nav nav-pills nav-stacked">
          ...
          <li><a href="underscore.html">9</a></li>
          <li class="active">
            <a href="variables.html">10</a>
          </li>
          <li class="next disabled">
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm/variables.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/yfm/variables.html</h4>  <h4>
          <strong>Dest filename:</strong> variables.html
        </h4>
          <h4><strong>Dest basename:</strong> variables</h4>  <h4>
          <strong>Page title:</strong> YAML Variables
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        This is an example YAML variable. Variables need to be the first thing in the line. If it shows up in the
        result, it worked!
        ...
        <p>YAML supports <strong>variables</strong>, or <strong>repeated nodes </strong>. The simplest explanation is
          that you define something as a variable by preceding it with &quot;&amp;NAME value&quot; and you can refer to
          it with &quot;*NAME&quot;
          e.g.:</p>
...
other_thing: *NAME</code></pre>
        <p>Parses to:</p>
        <pre><code class="language-json">{"<span class="attribute">other_thing</span>": <span class="value"><span
          class="string">"foobar"</span></span>, "<span class="attribute">some_thing</span>": <span class="value"><span
          class="string">"foobar"  </span></span>}</code></pre>
        <div class="docs-header" id="content">
          <h1>Content</h1>
        </div>
        <ul>
        ...
        <div style="display: none">
          ...
          page.filename:   variables.html
          page.pagename:   variables.html
          page.basename:   variables
          page.ext:        .html
          "root"
          ===============================
          src:
