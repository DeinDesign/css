...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm/lists.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/yfm/lists.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm/lists.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/yfm/lists.html</h4>  <h4>
          <strong>Dest filename:</strong> lists.html
        </h4>
          <h4><strong>Dest basename:</strong> lists</h4>  <h4>
          <strong>Page title:</strong> Almost a Haiku
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <div style="display: none">
          ...
          page.filename:   lists.html
          page.pagename:   lists.html
          page.basename:   lists
          page.ext:        .html
          "root"
          ===============================
