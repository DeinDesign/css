...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm/data-files.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/yfm/data-files.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm/data-files.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/yfm/data-files.html</h4>  <h4>
          <strong>Dest filename:</strong> data-files.html
        </h4>
          <h4><strong>Dest basename:</strong> data-files</h4>  <h4>
        ...
        <div style="display: none">
          ...
          page.filename:   data-files.html
          page.pagename:   data-files.html
          page.basename:   data-files
          page.ext:        .html
          "root"
          ===============================
          src:
