...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm/document.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/yfm/document.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm/document.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/yfm/document.html</h4>  <h4>
          <strong>Dest filename:</strong> document.html
        </h4>
          <h4><strong>Dest basename:</strong> document</h4>  <h4>
...
============================================ -->
        <div class="special-instructions" style="margin-bottom: 120px;">
          ...
          <p>Follow the Yellow Brick Road to the Emerald City. Pay no attention to the man behind the curtain.</p>
        </div>
        <div class="docs-header" id="content">
          <h1>Content</h1>
        </div>
        ...
        <div style="display: none">
          ...
          page.filename:   document.html
          page.pagename:   document.html
          page.basename:   document
          page.ext:        .html
          "root"
          ===============================
          src:
          ...
          <pre><code class="json">
{
  ...
  "page": "<!DOCTYPE html>\n  <html lang=\"en\">\n  <head>\n    <meta charset=\"UTF-8\">\n    <title>Layout filename: '{{layout}}'</title>\n    <link
            ...
            <!-- Column: content -->\n        <div class=\"col-md-9\" role=\"main\">\n          <div
              ...
              class=\"page-header\">\n  <h4>{{{title}}}</h4>\n</div>\n\n\n
              <!-- Customer Information\n============================================ -->\n<div
                class=\"customer-information\">\n  <h4 style=\"background: #eee; display:
                                                       block\">Customer Information</h4>\n  <dl class=\"dl-horizontal\">\n    <dt>Receipt:</dt>\n    <dd>{{receipt}}</dd>\n\n    <dt>Date:</dt>\n    <dd>{{prettyDate}}</dd>\n\n    <dt>First Name:</dt>\n    <dd>{{customer.given}}</dd>\n\n    <dt>Last Name:</dt>\n    <dd>{{customer.family}}</dd>\n  </dl>\n</div>\n\n<hr>\n\n
              <!-- Order Information\n============================================ -->\n<div
                class=\"customer-information\">\n  <h4 style=\"background: #eee; display: block\">Order Information</h4>
                \n  <dl class=\"dl-horizontal\">\n    <dt>Items:</dt>\n    {{#each items}}\n    <dd>\n      <strong
                  class=\"muted\" style=\"border-bottom: 1px solid #ddd; display: block\">Item #{{@index}}</strong>\n      <dl
                  class=\"dl-horizontal\">\n        <dt>Part No: </dt>\n        <dd> {{part_no}} </dd>\n        <dt>Description: </dt>\n        <dd> {{descrip}} </dd>\n        <dt>Price: </dt>\n        <dd> ${{price}} </dd>\n        <dt>Qty: </dt>\n        <dd> {{quantity}} </dd>\n      </dl>\n    </dd>\n    {{/each}}\n  </dl>\n</div>\n<hr>\n\n
              <!-- Bill To\n============================================ -->\n<div class=\"bill-to\">\n  <h4
                style=\"background: #eee; display: block\">Address Information</h4>\n  <strong>Bill To:</strong>\n  <dl
                class=\"dl-horizontal\">\n    <dt>Billing Street: </dt>\n    <dd> {{bill-to.street}} </dd>\n    <dt>Billing City: </dt>\n    <dd> {{bill-to.city}} </dd>\n    <dt>Billing State: </dt>\n    <dd> {{bill-to.state}} </dd>\n  </dl>\n                <strong>Ship To:</strong>\n  <dl
                class=\"dl-horizontal\">\n    <dt>Shipping Street: </dt>\n    <dd> {{ship-to.street}} </dd>\n    <dt>Shipping City: </dt>\n    <dd> {{ship-to.city}} </dd>\n    <dt>Shipping State: </dt>\n    <dd> {{ship-to.state}} </dd>\n    </dd>
                \n  </dl>\n</div>\n\n<!-- Special Instructions\n============================================ -->\n<div
                class=\"special-instructions\" style=\"margin-bottom: 120px;\">\n  <h4 style=\"background: #eee;
                                                                                       display: block\">Delivery Instructions</h4>
              \n  <p>{{{specialDelivery}}}</p>\n</div>\n\n            <div class=\"docs-header\" id=\"content\">\n              <h1>Content</h1>\n            </div>\n            <ul>\n            {{#each pages}}\n              <li> <a
