...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm/comments.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/yfm/comments.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm/comments.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/yfm/comments.html</h4>  <h4>
          <strong>Dest filename:</strong> comments.html
        </h4>
          <h4><strong>Dest basename:</strong> comments</h4>  <h4>
          <strong>Page title:</strong> Comments in YAML front matter
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <div style="display: none">
          ...
          page.filename:   comments.html
          page.pagename:   comments.html
          page.basename:   comments
          page.ext:        .html
          "root"
          ===============================
          src:
