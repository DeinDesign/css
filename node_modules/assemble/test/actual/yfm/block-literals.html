...
<div class="container">
  ...
  <div class="docs-section">
    <div class="docs-header" id="content">
      <h4><strong class="text-muted">test/fixtures/pages/yfm/block-literals.hbs</strong> &#x2192;
        <strong class="text-success">test/actual/yfm/block-literals.html</strong>
      </h4>
    </div>
    <hr>
  </div>
    ...
    <div class="col-md-9" role="main">
      <div class="docs-section">
        <div class="docs-header" id="content">
          ...
          <strong>Page src:</strong> test/fixtures/pages/yfm/block-literals.hbs
        </h4>
          <h4><strong>Page dest:</strong> test/actual/yfm/block-literals.html</h4>  <h4>
          <strong>Dest filename:</strong> block-literals.html
        </h4>
          <h4><strong>Dest basename:</strong> block-literals</h4>  <h4>
          <strong>Page title:</strong> Block Literals
        </h4>
        </div>
        <hr>
        <div class="row">
        ...
        <div style="display: none">
          ...
          page.filename:   block-literals.html
          page.pagename:   block-literals.html
          page.basename:   block-literals
          page.ext:        .html
          "root"
          ===============================
          src:
...
"poem": "\r\nold pond . . .\r\na frog leaps in\r\nwater’s sound\r\n",
"prev": 0,
"relativeLink": "block-literals.html",
"src": "test/fixtures/pages/yfm/block-literals.hbs",
"title": "Block Literals"
}
</code></pre>
