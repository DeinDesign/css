...
<head>
  ...
  <META NAME="Description"
        CONTENT="Trackerchecker.com is a torrent tracker checker. It will show you wich private torrent trackers are open for signup.">
...
<div id="holder" style="position:relative; margin-left:auto; margin-right:auto;width:520px;1px;">
  ...
  <table>
    <tr>
      <td>
        <a href="http://www.twitter.com/trackerchecker" target="_blank"><img src="images/twitter_trackerchecker.png"
                                                                             height="90" width="90"
                                                                             alt="follow us on Twitter" border="0"/></a><br/>
  ...
  <form action="send.php" method="post">
    <table>
      <tr>
        <td colspan="2">
          <b>We need your input!</b><br> We're developing a new version of Trackerchecker and we want to know what
          functionality the users like to see in Trackerchecker V3! :) Contribute please and tell us what you like to
          see in Trackerchecker V3!
        </td>
      </tr>
      <tr>
        <td>Name:</td>
      ...
      <tr>
        <td></td>
        <td><input type="hidden" name="subs"></td>
      </tr>
    </table>
  </form>
  <br>
  ...
  <div class="listitem">
    ...
    <table class="contenttable" cellpadding="0" cellspacing="0">
      ...
      <tr class="oddRow">
        <td></td>
        <td><a href="http://www.horrorcharnel.kicks-ass.org/signup.php" target="_blank">horrorcharnel.kicks-ass.org</a>
        </td>
      ...
      <tr class="evenRow">
        <td></td>
        <td><a href="http://www.overtopropetorrents.com/signup.php?agree=yes&invitehash=" target="_blank">overtopropetorrents.com</a>
        </td>
      ...
      <tr class="evenRow">
        <td></td>
        <td><a href="http://www.xtremewrestlingtorrents.net/signup.php" target="_blank">xtremewrestlingtorrents.net</a>
        </td>
