...
describe '#middleware', ->
  it 'renders a package in memory', (done) ->
    nap
      assets:
        css:
          foo: ['/test/fixtures/1/bar.css']
    nap.middleware {url: '/assets/test/fixtures/1/bar.css'}, {
      end: (data) ->
  ...
  it 'renders multiple files in a package in memory', (done) ->
    ...
    nap.middleware {url: '/assets/test/fixtures/1/foo.css'}, {
      end: (data) ->
  ...
  it 'serves up the jst files as well', ->
    nap
      assets:
        jst:
          foo: ['/test/fixtures/1/foo.jade']
    nap.middleware {url: '/assets/test/fixtures/1/foo.jst.js'}, {
      end: (data) ->
