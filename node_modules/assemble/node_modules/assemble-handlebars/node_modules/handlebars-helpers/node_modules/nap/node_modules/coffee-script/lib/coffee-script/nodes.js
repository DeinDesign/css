...
(function () {
  ...
  exports.Literal = Literal = (function (_super) {
    ...
    Literal.prototype.compileNode = function (o) {
      ...
      code = this.value === 'this' ? ((_ref2 = o.scope.method) != null ? _ref2.bound : void 0) ? o.scope.method.context
          : this.value : this.value.reserved ? "\"" + this.value + "\"" : this.value;
    ...
    Call.prototype.compileSplat = function (o, splatArgs) {
      ...
      if (this.isNew) {
        ...
        return [].concat(this.makeCode(
          ...
          this.variable.compileToFragments(o, LEVEL_LIST), this.makeCode(", "), splatArgs,
      ...
      if ((name = base.properties.pop()) && base.isComplex()) {
        ...
        answer = answer.concat(this.makeCode("(" + ref + " = "), base.compileToFragments(o, LEVEL_LIST),
          this.makeCode(")"), name.compileToFragments(o));
      } else {
  ...
  exports.Range = Range = (function (_super) {
    ...
    Range.prototype.compileVariables = function (o) {
      ...
      _ref7 = [this.fromVar.match(SIMPLENUM),
        this.toVar.match(SIMPLENUM)], this.fromNum = _ref7[0], this.toNum = _ref7[1];
      if (this.stepVar) {
    ...
    Range.prototype.compileNode = function (o) {
      ...
      condPart = this.stepNum ? +this.stepNum > 0 ? "" + lt + " " + this.toVar : "" + gt + " " + this.toVar : known
          ? ((_ref5 = [+this.fromNum, +this.toNum], from = _ref5[0], to = _ref5[1], _ref5), from <= to ? "" + lt + " "
            + to : "" + gt + " " + to) : (cond = this.stepVar ? "" + this.stepVar + " > 0" : "" + this.fromVar + " <= "
            + this.toVar, "" + cond + " ? " + lt + " " + this.toVar + " : " + gt + " " + this.toVar);
      stepPart = this.stepVar ? "" + idx + " += " + this.stepVar : known ? namedIndex ? from <= to ? "++" + idx : "--"
              + idx : from <= to ? "" + idx + "++" : "" + idx + "--" : namedIndex ? "" + cond + " ? ++" + idx + " : --"
            + idx : "" + cond + " ? " + idx + "++ : " + idx + "--";
      if (namedIndex) {
    ...
    Range.prototype.compileArray = function (o) {
      ...
      if (this.fromNum && this.toNum && Math.abs(this.fromNum - this.toNum) <= 20) {
        range = (function () {
          _results = [];
          for (var _i = _ref4 = +this.fromNum, _ref5 = +this.toNum; _ref4 <= _ref5 ? _i <= _ref5 : _i >= _ref5;
            _ref4 <= _ref5 ? _i++ : _i--) {
            _results.push(_i);
          }
          return _results;
      ...
      if (this.fromNum && this.toNum) {
        ...
        body = "var " + vars + "; " + cond + " ? " + i + " <" + this.equals + " " + this.toVar + " : " + i + " >"
          + this.equals + " " + this.toVar + "; " + cond + " ? " + i + "++ : " + i + "--";
      }
      post = "{ " + result + ".push(" + i + "); }\n" + idt + "return " + result + ";\n" + o.indent;
      ...
      if (to) {
        ...
        if (!(!this.range.exclusive && +compiledText === -1)) {
          toStr = ', ' + (this.range.exclusive ? compiledText : SIMPLENUM.test(compiledText) ? "" + (+compiledText + 1)
                : (compiled = to.compileToFragments(o, LEVEL_ACCESS), "+" + (fragmentsToText(compiled))
                + " + 1 || 9e9"));
        }
      }
  ...
  exports.Class = Class = (function (_super) {
    ...
    Class.prototype.determineName = function () {
      ...
      decl = (tail = last(this.variable.properties)) ? tail instanceof Access && tail.name.value
          ...
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              if (assign.variable["this"]) {
                ...
                assign.variable = new Value(new Literal(name), [new Access(new Literal('prototype')),
                  new Access(base)]);
  ...
  exports.Assign = Assign = (function (_super) {
    ...
    Assign.prototype.isStatement = function (o) {
      return (o != null ? o.level : void 0) === LEVEL_TOP && (this.context != null) && __indexOf.call(this.context, "?")
        >= 0;
    };
    ...
    Assign.prototype.compileNode = function (o) {
      ...
      if (this.value instanceof Code && (match = METHOD_DEF.exec(name))) {
        ...
        this.value.name = (_ref5 = (_ref6 = (_ref7 = match[2]) != null ? _ref7 : match[3]) != null ? _ref6 : match[4])
        != null ? _ref5 : match[5];
      }
    ...
    Assign.prototype.compileConditional = function (o) {
      ...
      if (!left.properties.length && left.base instanceof Literal && left.base.value !== "this" && !o.scope.check(
          left.base.value)) {
        this.variable.error("the variable \"" + left.base.value + "\" can't be assigned with " + this.context
    ...
    Assign.prototype.compileSplice = function (o) {
      ...
      answer = [].concat(this.makeCode("[].splice.apply(" + name + ", [" + fromDecl + ", " + to + "].concat("), valDef,
  ...
  exports.Splat = Splat = (function (_super) {
    ...
    Splat.compileSplattedArray = function (o, list, apply) {
      ...
      for (i = _i = 0, _len = args.length; _i < _len; i = ++_i) {
        ...
        args[i] = node instanceof Splat ? [].concat(node.makeCode("" + (utility('slice')) + ".call("), compiledNode,
            node.makeCode(")")) : [].concat(node.makeCode("["), compiledNode, node.makeCode("]"));
      }
      if (index === 0) {
        node = list[0];
      ...
      return [].concat(list[0].makeCode("["), base, list[index].makeCode("].concat("), concatPart,
        (last(list)).makeCode(")"));
    };
  ...
  exports.While = While = (function (_super) {
    ...
    While.prototype.compileNode = function (o) {
      ...
      answer = [].concat(this.makeCode(set + this.tab + "while ("), this.condition.compileToFragments(o, LEVEL_PAREN),
  ...
  exports.Op = Op = (function (_super) {
    ...
    Op.prototype.isChainable = function () {
      var _ref4;
      return (_ref4 = this.operator) === '<' || _ref4 === '>' || _ref4 === '>=' || _ref4 === '<=' || _ref4 === '==='
        || _ref4 === '!==';
    };
    ...
    Op.prototype.invert = function () {
      ...
      if (this.isChainable() && this.first.isChainable()) {
        ...
        return new Parens(this).invert();
      } else if (this.operator === '!' && (fst = this.first.unwrap()) instanceof Op && ((_ref4 = fst.operator) === '!'
        || _ref4 === 'in' || _ref4 === 'instanceof')) {
        return fst;
      } else {
        return new Op('!', this);
      }
    ...
    Op.prototype.compileNode = function (o) {
      ...
      if (((_ref4 = this.operator) === '--' || _ref4 === '++') && (_ref5 = this.first.unwrapAll().value, __indexOf.call(
          STRICT_PROSCRIBED, _ref5) >= 0)) {
      ...
      answer = [].concat(this.first.compileToFragments(o, LEVEL_OP), this.makeCode(' ' + this.operator + ' '),
    ...
    Op.prototype.compileChain = function (o) {
      ...
      fragments = fst.concat(this.makeCode(" " + (this.invert ? '&&' : '||') + " "), shared.compileToFragments(o),
        this.makeCode(" " + this.operator + " "), this.second.compileToFragments(o, LEVEL_OP));
      return this.wrapInBraces(fragments);
    };
    ...
    Op.prototype.compileUnary = function (o) {
      ...
      plusMinus = op === '+' || op === '-';
      if ((op === 'new' || op === 'typeof' || op === 'delete') || plusMinus && this.first instanceof Op
  ...
  exports.In = In = (function (_super) {
    ...
    In.prototype.compileLoopTest = function (o) {
      ...
      fragments = [].concat(this.makeCode(utility('indexOf') + ".call("), this.array.compileToFragments(o, LEVEL_LIST),
  ...
  exports.Try = Try = (function (_super) {
    ...
    Try.prototype.compileNode = function (o) {
      ...
      catchPart = this.recovery ? (placeholder = new Literal('_error'), this.errorVariable ? this.recovery.unshift(
            new Assign(this.errorVariable, placeholder)) : void 0, [].concat(this.makeCode(" catch ("),
          placeholder.compileToFragments(o), this.makeCode(") {\n"), this.recovery.compileToFragments(o, LEVEL_TOP),
          this.makeCode("\n" + this.tab + "}"))) : !(this.ensure || this.recovery) ? [this.makeCode(
            ' catch (_error) {}')] : [];
      ensurePart = this.ensure ? [].concat(this.makeCode(" finally {\n"), this.ensure.compileToFragments(o, LEVEL_TOP),
          this.makeCode("\n" + this.tab + "}")) : [];
      return [].concat(this.makeCode("" + this.tab + "try {\n"), tryPart, this.makeCode("\n" + this.tab + "}"),
        catchPart, ensurePart);
    };
  ...
  exports.Parens = Parens = (function (_super) {
    ...
    Parens.prototype.compileNode = function (o) {
      ...
      bare = o.level < LEVEL_OP && (expr instanceof Op || expr instanceof Call || (expr instanceof For
        && expr.returns));
      if (bare) {
        return fragments;
      } else {
  ...
  exports.For = For = (function (_super) {
    ...
    For.prototype.compileNode = function (o) {
      ...
      return [].concat(defPartFragments, this.makeCode("" + (resultPart || '') + this.tab + "for ("), forPartFragments,
        this.makeCode(") {" + guardPart + varPart), bodyFragments,
    ...
    For.prototype.pluckDirectCall = function (o, body) {
      ...
      for (idx = _i = 0, _len = _ref4.length; _i < _len; idx = ++_i) {
        ...
        if (!((val instanceof Code) || (val instanceof Value && ((_ref5 = val.base) != null ? _ref5.unwrapAll()
            : void 0) instanceof Code && val.properties.length === 1 && ((_ref6 = (_ref7 = val.properties[0].name)
          != null ? _ref7.value : void 0) === 'call' || _ref6 === 'apply')))) {
          continue;
        }
        ...
        defs = defs.concat(this.makeCode(this.tab), new Assign(ref, fn).compileToFragments(o, LEVEL_TOP),
          this.makeCode(';\n'));
      }
      return defs;
    };
  ...
  exports.Switch = Switch = (function (_super) {
    ...
    Switch.prototype.compileNode = function (o) {
      ...
      fragments = [].concat(this.makeCode(this.tab + "switch ("),
      ...
      for (i = _i = 0, _len = _ref4.length; _i < _len; i = ++_i) {
        ...
        for (_j = 0, _len1 = _ref6.length; _j < _len1; _j++) {
          ...
          fragments = fragments.concat(this.makeCode(idt1 + "case "), cond.compileToFragments(o, LEVEL_PAREN),
            this.makeCode(":\n"));
        }
      ...
      if (this.otherwise && this.otherwise.expressions.length) {
        fragments.push.apply(fragments,
          [this.makeCode(idt1 + "default:\n")].concat(__slice.call(this.otherwise.compileToFragments(o, LEVEL_TOP)),
            [this.makeCode("\n")]));
      }
  ...
  exports.If = If = (function (_super) {
    ...
    If.prototype.isStatement = function (o) {
      var _ref4;
      return (o != null ? o.level : void 0) === LEVEL_TOP || this.bodyNode().isStatement(o)
        || ((_ref4 = this.elseBodyNode()) != null ? _ref4.isStatement(o) : void 0);
    };
  ...
  UTILITIES = {
    "extends": function () {
      return "function(child, parent) { for (var key in parent) { if (" + (utility('hasProp'))
