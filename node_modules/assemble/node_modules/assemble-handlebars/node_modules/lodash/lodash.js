...
;(function () {
  ...
  function runInContext(context) {
    ...
    (function () {
       ...
       * @type boolean
       */
      support.enumErrorProps = propertyIsEnumerable.call(errorProto, 'message') || propertyIsEnumerable.call(errorProto,
          'name');
    ...
    function baseIsEqual(a, b, callback, isWhere, stackA, stackB) {
      ...
      forIn(b, function (value, key, b) {
        if (hasOwnProperty.call(b, key)) {
          ...
          return (result = hasOwnProperty.call(a, key) && baseIsEqual(a[key], value, callback, isWhere, stackA,
              stackB));
        }
      });
    ...
    function contains(collection, target, fromIndex) {
      ...
      if (isArray(collection)) {
        ...
        result = (isString(collection) ? collection.indexOf(target, fromIndex) : indexOf(collection, target, fromIndex))
          > -1;
      } else {
