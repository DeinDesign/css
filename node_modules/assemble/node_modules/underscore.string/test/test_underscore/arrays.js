$(document).ready(function () {
  ...
  test("compact", function () {
    ...
    var result = (function () {
      return _(arguments).compact().length;
    })(0, 1, false, 2, false, 3);
  ...
  test("uniq", function () {
    ...
    equal(_.map(_.uniq(list, false, iterator), iterator).join(', '), 'moe, curly, larry',
