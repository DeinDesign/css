...
// livereload
  ...
  __livereload.LiveReload = LiveReload = (function () {
    ...
    function LiveReload(window) {
      ...
      this.console = this.window.location.href.match(/LR-verbose/) && this.window.console && this.window.console.log
      && this.window.console.error ? this.window.console : {
          log: function () {
          },
          error: function () {
          }
      ...
      this.connector = new Connector(this.options, this.WebSocket, Timer, {
        ...
        disconnected: function (reason, nextDelay) {
          ...
          switch (reason) {
            case 'cannot-connect':
              return _this.log(
                "LiveReload cannot connect to " + _this.options.host + ":" + _this.options.port + ", will retry in "
                + nextDelay + " sec.");
            case 'broken':
              return _this.log(
                "LiveReload disconnected from " + _this.options.host + ":" + _this.options.port + ", reconnecting in "
                + nextDelay + " sec.");
            ...
            default:
              return _this.log(
                "LiveReload disconnected from " + _this.options.host + ":" + _this.options.port + " (" + reason
    ...
    LiveReload.prototype.analyze = function () {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        plugin = _ref[_i];
        pluginsData[plugin.constructor.identifier] = pluginData = (typeof plugin.analyze === "function"
  ...
  __less = LessPlugin = (function () {
    ...
    LessPlugin.prototype.reloadLess = function (path) {
      ...
      links = (function () {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          link = _ref[_i];
          if (link.href && link.rel === 'stylesheet/less' || (link.rel.match(/stylesheet/) && link.type.match(
              /^text\/(x-)?less$/))) {
            _results.push(link);
          }
        }
