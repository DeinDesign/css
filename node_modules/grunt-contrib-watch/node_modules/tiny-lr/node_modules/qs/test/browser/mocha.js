 ...
 *      });
    ...
    function HTML(runner) {
      ...
      runner.on('test end', function (test) {
        ...
        if ('passed' == test.state) {
          var el = fragment('<div class="test pass %e"><h2>%e<span class="duration">%ems</span></h2></div>', test.speed,
  ...
  require.register("reporters/teamcity.js", function (module, exports, require) {
    ...
    function Teamcity(runner) {
      ...
      runner.on('fail', function (test, err) {
        console.log(
          "##teamcity[testFailed name='" + escape(test.fullTitle()) + "' message='" + escape(err.message) + "']");
      });
      ...
      runner.on('test end', function (test) {
        console.log(
          "##teamcity[testFinished name='" + escape(test.fullTitle()) + "' duration='" + test.duration + "']");
      });
