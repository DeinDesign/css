...
var API = {
  ...
  _open: function () {
    if (this._parser && !this._parser.isOpen()) {
      return;
    }
  ...
  close: function (code, reason, ack) {
    ...
    if (this.readyState === API.CLOSING && ack !== false) {
      return;
    }
    ...
    if (ack === false) {
      if (this._parser.close) {
        this._parser.close(code, reason);
      }
      finalize.call(this);
    } else {
      if (this._parser.close) {
        this._parser.close(code, reason, finalize, this);
      } else {
        finalize.call(this);
      }
    }
