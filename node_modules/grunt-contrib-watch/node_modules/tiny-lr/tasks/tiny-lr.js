...
module.exports = function (grunt) {
  ...
  //      }
  //
  grunt.registerTask('tinylr-reload',
    'Sends a reload notification to the livereload server, based on `watchFiles.changed`', function () {
      if (!server) {
        return;
      }
      var files = changed();
  ...
  function changed() {
    if (grunt.file.watchFiles) {
      return grunt.file.watchFiles.changed;
    }
