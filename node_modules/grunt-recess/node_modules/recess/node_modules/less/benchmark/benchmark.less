  ...
  div.header {
    ...
    span.filter {
      ...
      a {
        ...
        :first-child {
          .border_radius_left(2);
        }
        :last-child {
          .border_radius_right(2);
          margin-right: 0;
        }
      }
    }
    ...
    li {
      ...
      div.thumbnail {
        ...
        .marker.coupon {
          ...
          span {
            ...
            padding: 0 4px 0 2px;
            background: @accent_colour;
            .text_shadow(1, 1, 0px, (@accent_colour * 0.75 + @black * 0.25));
            margin: 0 0 0 14px;
          }
        }
        .marker.video {
      ...
      :hover {
        ...
        div.text {
          ...
          a.title:before {
            background: @accent_colour;
            .box_shadow(-5, 0, 10, @accent_colour);
          }
          small {
...
div.browse.with_options > ul {
  .border_radius_top(0);
}

div.browse.with_footer > ul {
...
div.browse.list.with_options ul {
  .border_radius_top(0);
}

div.browse.list.with_footer ul {
  .border_radius_bottom(0);
}
...
div.panel {
  margin: 0 0 20px;
  position: relative;
  .box_shadow(0, 0, 3, @light_grey * 0.66 + @white * 0.33);
  .border_radius(3);
  > div.header {
    background: @bg url('/images/panel_header_bg.png') repeat-x top left;
    border-bottom: 1px solid (@bg * 0.66 + @black * 0.33);
...
div.panel.no_footer div.content {
  .border_radius_bottom(3);
}

div.panel.no_header div.content {
  .border_radius_top(3);
}
    ...
    div.extra {
      ...
      #more_info {
        ...
        h4 {
          color: @white;
          margin: 0 0 10px 0;
          border-bottom: 1px solid (@white * 0.25 + @bg * 0.75);
          .text_shadow(1, 1, 0, @bg * 0.66 + @black * 0.33);
          span {
            font-size: 12px;
          }
...
#activity {
  div.content {
    ul.events {
      ...
      li.voted div.description span.action {
        .border_radius(2);
        color: @dark_grey;
        padding: 0 3px;
        white-space: nowrap;
